...
public class CreditsPanel extends ApexPanel {
    ...
    private CreditsPanel() {
        ...
        this.addBox("North",
            ...
            Util.apply(new WrappedTextArea("Credits"), textArea -> textArea.setFont(new Font(Font.SANS_SERIF, Font.BOLD, 14)), jLabel -> jLabel.setAlignmentX(0)),
